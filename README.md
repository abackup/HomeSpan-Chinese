...
欢迎使用 HomeSpan - 一个强大且极其易于使用的 Arduino 库<mark style="background-color: #fff000;">被标记的词</mark>，用于完全在 [Arduino IDE](http://www.arduino.cc) 内创建你自己的基于 [ESP32](https://www.espressif.com/en/products/modules/esp32) 的 HomeKit 设备。
