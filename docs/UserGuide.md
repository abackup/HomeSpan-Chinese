<!-- 原文时间：2023.5.16，校对时间：校对时间：2025.2.28 -->
...
4. [设备配置模式](#设备配置模式)
5. [设置HomeSpan 的 WiFi 凭据和设置代码](#设置-homespan-的-wifi-凭据和设置代码)
6. [与 homekit 配对](#与-homekit-配对)
7. [恢复出厂设置](#恢复出厂设置)
8. [创建可扫描标签](#创建可扫描标签)
9. [状态指示灯闪烁参考](#状态指示灯闪烁参考)
...
安装方法：首先打开 Mac 上的 Finder，前往根目录（通常名为“Macintosh HD”），然后在 Finder 的搜索栏中输入“scancardium”。此时，Finder 主窗口中应该会显示文件“Scancardium_2.0.tff”。接下来，双击该文件，在“字体册”中打开它。然后在“字体册”中，点击“安装字体”。现在，Scancardium 字体就可以使用了。
...
请注意，如果在 *Pages* 或 *Keynote* 字体下拉框中找不到 *Scancardium* 作为字体选项列出，请从 *Pages* 或 *Keynote* 的菜单栏中选择 *格式→字体→显示字体* 应用显示所有已安装字体的列表，你可以在其中搜索并选择 *Scancardium*。
